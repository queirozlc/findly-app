...
import { serviceProviderPositionState } from '../store/atoms/service-provider-position-state'
...
export function useMap() {
  ...
  const setPositionState = useSetRecoilState(serviceProviderPositionState)
